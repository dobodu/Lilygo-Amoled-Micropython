                                        ...
                                        size_t         color_size)		// size of color buffer
{
    ...
    amoled_qspi_bus_obj_t *qspi_panel_obj = (amoled_qspi_bus_obj_t *)self;			// qspi_panel_obj is pointer to display buffer
...
{
    (void) kind;
    amoled_qspi_bus_obj_t *self = MP_OBJ_TO_PTR(self_in);
    mp_printf(
        print,
                                           ...
                                           const mp_obj_t      *all_args)
{
    ...
    // create new object
    amoled_qspi_bus_obj_t *self = m_new_obj(amoled_qspi_bus_obj_t);
    self->base.type = &amoled_qspi_bus_type;
...
MP_DEFINE_CONST_OBJ_TYPE(
    amoled_qspi_bus_type,
    MP_QSTR_QSPI_Panel,
    MP_TYPE_FLAG_NONE,
    print, amoled_qspi_bus_print,
    make_new, amoled_qspi_bus_make_new,
    protocol, &mp_lcd_panel_p,
    locals_dict, (mp_obj_dict_t *)&amoled_qspi_bus_locals_dict
);
#else
const mp_obj_type_t amoled_qspi_bus_type = {
    { &mp_type_type },
